...
function gulp_wp_theme_scripts() {
	...
	wp_enqueue_script( $theme_handle_prefix . '-scripts', get_template_directory_uri() . '/assets/js/' . $theme_handle_prefix . '.min.js', array(), '1.0.0', true );
}
